...
<head>
    ...
    <title>Contact Us - Global Express Lotto</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
     <!-- site favicon -->
    ...
    <script src="../cdn.jsdelivr.net/npm/bootstrap%405.3.0-alpha1/dist/js/bootstrap.bundle.min.js" integrity="sha384-w76AqPfDkMBDXo30jS1Sgez6pr3x5MlQ1ZAGC+nuZB+EYdgRZgiwxhTBTkF7CXvN" crossorigin="anonymous"></script>    <script src="http://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
            ...
            <div class="contact-area d-flex">
              <div class="contact-form-area">
                ...
                <form class="contact-form" method="post">
                  <div class="form-grp">
                    <input type="text" name="FullName" id="contact_name" placeholder="Full Name" required>
                  </div>
                  <div class="form-grp">
                    <input type="email" name="Email" id="contact_email" placeholder="Email Address" required>
                  </div>
                  <div class="form-grp">
                    <input type="tel" name="PhoneNumber" id="contact_phone" placeholder="Phone No" required>
                  </div>
                  <div class="form-grp">
                    <textarea name="Message" id="contact_message" placeholder="Message" required></textarea>
                  </div>
                  <div class="form-grp">
                    <input class="submit-btn" name="btncontactUS" type="submit" value="send message"> 
                  </div>
                </form>
                  ...
                  <h3 class="title">Contact Us</h3>
                   <ul>
                    ...
                    <li>
                      ...
                      <div class="content">
                        <p ><a href="#"></i><span class="__cf_email__" data-cfemail="f39a9d959cb3809c8187969cdd909c9e" style="color:white;">[admin@globalexpresslotto.com]</span></a></p>
                        <!-- <p><a href="https://pixner.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="3c55525a537c4f534e485953125f5351">[email&#160;protected]</a></p> -->
                      </div>
                    </li>
                  </ul>
                </div>
...
<!-- Mirrored from Global Express Lotto.com/contact by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Sep 2023 13:00:27 GMT -->
</html>